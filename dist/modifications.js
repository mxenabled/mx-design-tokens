...
// Shared
var updatedBoxShadow = (0, _utilities.updateValues)(_core["default"].BoxShadow, '');
var updatedEasing = (0, _utilities.updateValues)(_core["default"].Easing, {
  x1: 0.475,
  y1: 0.425,
  x2: 0,
  y2: 0.995
...
var updatedTime = (0, _utilities.addSuffix)(_core["default"].Time, 'ms'); // Native

var updatedLineHeight = (0, _utilities.removeSuffix)(_core["default"].LineHeight, 'px');

var getTargetSpecificTokens = function getTargetSpecificTokens(target, tokenOverrides) {
  var coreTokens = (0, _utilities.deepMerge)(_core["default"], tokenOverrides);
