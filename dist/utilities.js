...
exports.updateValues = exports.removeSuffix = exports.addSuffix = exports.splitTokens = exports.collapseTokens = exports.expandTokens = exports.isCoreProp = exports.deepMerge = exports.isObject = void 0;
...
var isCoreProp = function isCoreProp(fullToken) {
  var foundInCore = false;
...
var collapseTokens = function collapseTokens(tokenList) {
  ...
  return retToken;
}; // divide tokenList into 2 separate arrays of individual tokens
// { coreTokens, otherTokens }
